    ...
    try:
        ...
        with serial.Serial(SERIAL_PORT, BAUD_RATE, timeout=TIMEOUT) as ser:
            ...
            with open(csv_filename, mode="w", newline="") as csvfile:
                ...
                header = []
                for i in range(num_values * num_reads):
                    header.append(f"Magnitude {i + 1} (dB)")
                ...
                for entry in parsed_data:
                    ...
                    csv_writer.writerow([magnitude_db, phase])
            ...
            # Combined plot
            plt.plot(magnitude_data_db, label="Magnitude (dB)", color="blue")
            plt.plot(phase_data, label="Phase (radians)", color="orange")
